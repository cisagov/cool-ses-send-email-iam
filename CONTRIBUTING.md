...
issue](https://github.com/cisagov/cool-ses-send-email-iam/issues) in this
...
request](https://github.com/cisagov/cool-ses-send-email-iam/pulls), you
...
```console
cd cool-ses-send-email-iam
pyenv virtualenv <python_version_to_use> cool-ses-send-email-iam
pyenv local cool-ses-send-email-iam
